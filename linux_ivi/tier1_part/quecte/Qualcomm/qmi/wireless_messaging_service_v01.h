...
/** @addtogroup wms_qmi_enums
  ...
  */
typedef enum {
  WMS_MSG_ENCODING_FORMAT_ENUM_MIN_ENUM_VAL_V01 = -2147483647,      /**< To force a 32 bit signed enum.  Do not change or use*/
  WMS_MSG_ENCODING_FORMAT_GSM_7BIT              = 0,             /**<  Message format default GSM 7-bit. */
  WMS_MSG_ENCODING_FORMAT_TEXT_BINARY_V01       = 1,             /**<  Message format Binary/ASCII text. */
  WMS_MSG_ENCODING_FORMAT_TEXT_UCS2_V01         = 2,             /**<  Message format UTF8 text. */
  WMS_MSG_ENCODING_FORMAT_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wms_message_encoding_format_enum_v01;
/**
    @}
  */
