...
TC_COMMIT(struct xtc_handle *handle)
{
 ...
 #if 0
	printf("handle is hook_entry %d %d %d %d %d\n",handle->info.hook_entry[0],handle->info.hook_entry[1],handle->info.hook_entry[2],handle->info.hook_entry[3],handle->info.hook_entry[4]);
	printf("handle is underflow %d %d %d %d %d\n",handle->info.underflow[0],handle->info.underflow[1],handle->info.underflow[2],handle->info.underflow[3],handle->info.underflow[4]);
	
	printf("rep is hook_entry %d %d %d %d %d\n",repl->hook_entry[0],repl->hook_entry[1],repl->hook_entry[2],repl->hook_entry[3],repl->hook_entry[4]);
	printf("rep is underflow %d %d %d %d %d\n",repl->underflow[0],repl->underflow[1],repl->underflow[2],repl->underflow[3],repl->underflow[4]);
	 printf("sizeof is %d\n",(sizeof(*repl) + repl->size));

	printf("repl name %s\n",repl->name);
printf("repl valid_hooks %d\n",repl->valid_hooks);
printf("repl num_entries %d\n",repl->num_entries);
printf("repl size %d  %d\n",repl->size,handle->sockfd);
printf("repl num_counters %d\n",repl->num_counters);
printf("repl pb_counters %d %d\n",repl->counters->pcnt,repl->counters->bcnt);
	while(1){}
	#endif
