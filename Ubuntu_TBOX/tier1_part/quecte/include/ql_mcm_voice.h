...
typedef enum 
{
	E_QL_MCM_MCM_VOICE_MUTE 	= 0, /**<  Mute. */
	E_QL_MCM_MCM_VOICE_UNMUTE 	= 1, /**<  Unmute. */
}E_QL_MCM_VOICE_MUTE_TYPE_T;

typedef enum 
{
	E_QL_MCM_MCM_VOICE_SPEAKER 	= 0, /**<  Speaker. */
	E_QL_MCM_MCM_VOICE_MIC 		= 1, /**<  MIC. */
}E_QL_MCM_VOICE_MUTE_NAME_T;

typedef struct
{
  uint8_t is_mute;	 						/**<   Indicates whether a call is muted.*/
  E_QL_MCM_VOICE_MUTE_NAME_T mute_name;  	/**<   Mute name type.*/
}ql_mcm_voice_mute_t;
...
typedef ql_mcm_voice_mute_t	ql_mcm_voice_mute_ind;
...
//Ecall Push caommand
int QL_Voice_Call_Ecall_MsdPush(voice_client_handle_type h_voice,E_QL_MCM_ECALL_STATE_T *ecall_state);

//Get Ecall config info
int QL_Voice_Call_Ecall_GetConfigInfo(voice_client_handle_type h_voice,ql_mcm_ecall_config_info *ecall_config);
...
//Set voice mute
int QL_Voice_Call_SetMuteSetting
(
	int h_voice, 
	E_QL_MCM_VOICE_MUTE_TYPE_T mute_type,
	E_QL_MCM_VOICE_MUTE_NAME_T mute_name
);
