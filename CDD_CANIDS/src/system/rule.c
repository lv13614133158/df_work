...
static Signal_Elmt msgList[SK_SIGNALMAX_NUM] = {
    {4, 0x216, 0, 2,  SIG_TYPE_THR, 3, {10, 25, 0}},
    {4, 0x2C6, 0, 4,  SIG_TYPE_CHA, 4, {10, 100, 0, 0}},
    {4, 0x2C6, 0, 4,  SIG_TYPE_ELM, 7, {1, 3, 5, 6, 7, 8, 10}},
    {4, 0x216, 0, 4,  SIG_TYPE_TRA, 3, {10, 100, 5}},
    {4, 0x216, 0, 4,  SIG_TYPE_STA, 4, {3, 15, 8, 11}},
    {4, 0x216, 0, 4,  SIG_TYPE_PRE, 3, {15, 3, 10}},
    {4, 0x216, 0, 3,  SIG_TYPE_SIM, 3, {1, 3, 6}},
    {4, 0x216, 0, 3,  SIG_TYPE_DIS, 3, {5, 3, 7}},
};
